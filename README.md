Open Source Audit 鈥  Git
---
馃懁 Student Details
Name: Nikita Panda
Registration Number: 24BSA10003
...
In this audit, I studied Git鈥檚 origin, its licensing model, its role in the Linux ecosystem, and how it compares to proprietary alternatives. Along with the theoretical analysis, I also implemented practical tasks using Linux shell scripting to demonstrate hands-on understanding.
...
```
This command installs Git using the system鈥檚 package manager.
---
...
---
馃摐 Detailed Script Explanation
馃敼 Script 1 鈥  System Identity Report
...
---
馃敼 Script 2 鈥  FOSS Package Inspector
...
---
馃敼 Script 3 鈥  Disk and Permission Auditor
...
---
馃敼 Script 4 鈥  Log File Analyzer
...
---
馃敼 Script 5 鈥  Open Source Manifesto Generator
